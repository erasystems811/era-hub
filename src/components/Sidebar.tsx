...
const NAV: NavItem[] = [
...

  {
    ...
    children: [
      ...
      { path: '/comms/broadcasts',  label: 'Broadcasts',     icon: <Upload className="w-4 h-4" />,          accent: 'pink' },
      { path: '/comms/automations', label: 'Automations',    icon: <Zap className="w-4 h-4" />,             accent: 'pink' },
      ...
      { path: '/comms/moderation',  label: 'Moderation',     icon: <Zap className="w-4 h-4" />,             accent: 'pink' },
      { path: '/comms/ai-engine',   label: 'Auto-Reply',     icon: <Bot className="w-4 h-4" />,             accent: 'pink' },
      ...
      { path: '/comms/revenue',     label: 'Revenue',        icon: <CreditCard className="w-4 h-4" />,      accent: 'pink' },
      { path: '/comms/optouts',     label: 'Opt-Outs',       icon: <Zap className="w-4 h-4" />,             accent: 'pink' },
